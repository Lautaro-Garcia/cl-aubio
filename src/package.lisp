(defpackage :cl-aubio
  ...
  (:export
     ...
     :make-pitch-detector :detect-pitch :tolerance :pitch-detection-unit
     :make-onset-detector :reset-onset-detector :adaptive-whitening-enabled? :compression-factor :minimum-inter-onset-interval :time-of-latest-onset-detected :detect-onset
