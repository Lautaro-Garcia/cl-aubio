(defpackage :cl-aubio
  ...
  (:export
     ...
     :value :unit
     :with-source :do-source :make-source :read-source :number-of-channels :duration :samplerate :seek
     ...
     :make-sink :sink-samplerate-preset-error :sink-number-of-channels-preset-error :write-sink :with-sink
